...
(function () {
  ...
  const DICT = {
    en: { "dock.logs":"Logs","dock.redaction":"Writing","dock.settings":"Settings","tab.events":"👁️ Monitor (events)","tab.proxmox":"🖧 Proxmox", "dock.office":"Open Space","dock.cockpit":"Cockpit","dock.code":"Code","dock.design":"Design","dock.tasks":"Tasks","dock.more":"More","dock.graph":"Graph","dock.branches":"Branches","dock.memory":"Memory","dock.meeting":"Meetings","dock.console":"Console","dock.orchestrator":"Orchestrator",
    ...
    es: { "dock.logs":"Registros","dock.redaction":"Escritura","dock.settings":"Ajustes","tab.events":"👁️ Vigía (eventos)","tab.proxmox":"🖧 Proxmox", "dock.office":"Open Space","dock.cockpit":"Cockpit","dock.code":"Código","dock.design":"Diseño","dock.tasks":"Tareas","dock.more":"Más","dock.graph":"Grafo","dock.branches":"Ramas","dock.memory":"Memoria","dock.meeting":"Reuniones","dock.console":"Consola","dock.orchestrator":"Orquestador",
    ...
    it: { "dock.logs":"Log","dock.redaction":"Scrittura","dock.settings":"Impostazioni","tab.events":"👁️ Sentinella (eventi)","tab.proxmox":"🖧 Proxmox", "dock.office":"Open Space","dock.cockpit":"Cockpit","dock.code":"Codice","dock.design":"Design","dock.tasks":"Attività","dock.more":"Altro","dock.graph":"Grafo","dock.branches":"Rami","dock.memory":"Memoria","dock.meeting":"Riunioni","dock.console":"Console","dock.orchestrator":"Orchestratore",
    ...
    de: { "dock.logs":"Protokolle","dock.redaction":"Schreiben","dock.settings":"Einstellungen","tab.events":"👁️ Überwachung (Ereignisse)","tab.proxmox":"🖧 Proxmox", "dock.office":"Open Space","dock.cockpit":"Cockpit","dock.code":"Code","dock.design":"Design","dock.tasks":"Aufgaben","dock.more":"Mehr","dock.graph":"Graph","dock.branches":"Branches","dock.memory":"Speicher","dock.meeting":"Meetings","dock.console":"Konsole","dock.orchestrator":"Orchestrator",
    ...
    zh: { "dock.logs":"日志","dock.redaction":"写作","dock.settings":"设置","tab.events":"👁️ 监视（事件）","tab.proxmox":"🖧 Proxmox", "dock.office":"工作区","dock.cockpit":"驾驶舱","dock.code":"代码","dock.design":"设计","dock.tasks":"任务","dock.more":"更多","dock.graph":"图谱","dock.branches":"分支","dock.memory":"记忆","dock.meeting":"会议","dock.console":"控制台","dock.orchestrator":"编排器",
    ...
    ja: { "dock.logs":"ログ","dock.redaction":"執筆","dock.settings":"設定","tab.events":"👁️ 監視（イベント）","tab.proxmox":"🖧 Proxmox", "dock.office":"オープンスペース","dock.cockpit":"コックピット","dock.code":"コード","dock.design":"デザイン","dock.tasks":"タスク","dock.more":"その他","dock.graph":"グラフ","dock.branches":"ブランチ","dock.memory":"メモリ","dock.meeting":"会議","dock.console":"コンソール","dock.orchestrator":"オーケストレーター",
