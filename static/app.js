...
const BEHAVIOR_SCHEMA = [
    ...
    { section: "Intégrations externes (météo · transports · trafic · OCR)", icon: "🌍", fields: [
        ...
        { key: "TRANSPORT_PROVIDER", label: "Fournisseur transports en commun", help: "« Auto » = Transitland si sa clé est posée, sinon Navitia. Navitia = idéal France (+ itinéraires) ; Transitland = mondial (départs/retards, sans itinéraire).", type: "select", options: [["auto", "Auto (selon clé)"], ["navitia", "Navitia (France)"], ["transitland", "Transitland (mondial)"]], def: "auto" },
        { key: "NAVITIA_API_KEY", label: "Clé Navitia (transports — France)", help: "Horaires/retards/itinéraires train & tram/bus en temps réel (France). Clé gratuite sur navitia.io.", type: "password", def: "" },
        ...
        { key: "TRANSITLAND_API_KEY", label: "Clé Transitland (transports — mondial)", help: "Départs/retards des transports en commun partout dans le monde. Clé gratuite instantanée sur transit.land.", type: "password", def: "" },
