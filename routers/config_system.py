...
async def get_config_env() -> Dict[str, str]:
    try:
        ...
        typical_keys = [
            ...
            "HABIT_MINING", "CODE_REVIEW", "SWARM_VERIFY_SOFT_LIMIT",
            "DELEGATION_ROUTER", "FAST_MODEL", "FALLBACK_MODELS", "AUTO_CRITIC",
            "LLM_EXTRA_BODY", "LLM_RESPONSE_FORMAT", "HABIT_SIM_THRESHOLD", "AGENTS_FULL_TOOLS",
            "USER_MODELING", "SELF_IMPROVE_SKILLS", "TOOL_SCRIPTS", "PROMPT_CACHE",
            "AUTO_CONTINUE", "AUTO_CONTINUE_MAX", "DOCUMENT_MODEL",
