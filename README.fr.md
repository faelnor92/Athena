...
**Langues :** Français (ce fichier) · [English](README.md) · [Español](README.es.md) · [Italiano](README.it.md) · [Deutsch](README.de.md) · [中文](README.zh.md) · [日本語](README.ja.md)

**Mots-clés :** `multi-agent`, `ai-orchestrator`, `self-hosted`, `low-resource-llm`, `home-assistant`, `computer-use`, `mcp-server`, `kokoro-tts`, `swarm-intelligence`, `docker-sandbox`

> [!WARNING]
> **Développement Actif** : Ce framework est en cours de développement actif. Attendez-vous à des bugs, des fonctionnalités expérimentales et de potentielles modifications majeures. Vos contributions, retours d'expérience et rapports de bugs sont les bienvenus !

Athena est un framework d'agents IA et un orchestrateur multi-agents d'entreprise auto-hébergé, ultra-modulaire et pensé pour fonctionner sur des serveurs légers ou avec des GPU modestes. Accessible via une interface web réactive (dashboard 3D isométrique), Athena intègre des boucles d'auto-correction de code, un assistant vocal local (TTS/STT), une sandbox Docker sécurisée et des connecteurs domotiques (Home Assistant) et réseaux (Model Context Protocol).
...
<details>
<summary><b>Cliquez pour afficher les détails du déploiement multi-worker</b></summary>
...
<details>
<summary><b>Cliquez pour afficher les détails de sécurité et garde-fous en production</b></summary>
...
<details>
<summary><b>Cliquez pour afficher les détails d'intégration d'observabilité Phoenix</b></summary>
...
<details>
<summary><b>Cliquez pour afficher le tableau comparatif complet (Athena vs CrewAI, AutoGen, OpenClaw, Hermes)</b></summary>
